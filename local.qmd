...
The University of British Columbia's Vancouver campus sits on the traditional, ancestral, and unceded territory of the xʷməθkʷəy̓əm (Musqueam) people.[^1: "Unceded" means that the Musqueam people never signed a treaty ceding their lands to the Crown.] Visitors to campus will notice Musqueam presence throughout — in the street signs, the public art, the totem poles, and the names of buildings and residences. 
...
We have a limited number of discounted rooms with Gage Suites on campus at $262 CAD per night + tax. Use the [group booking link]( 
...
Tap-to-pay (with Compass Card or contactless credit/debit card) is the simplest way to pay. Single fares, day passes, and multi-day passes are available. For planning, use the [TransLink Trip Planner](https://www.translink.ca/).
...
Canada uses the **Canadian dollar (CAD)**. At the time of writing, the Canadian dollar trades at a discount relative to the US dollar and Euro, which makes Vancouver reasonably affordable for many international visitors despite its reputation as an expensive city.
...
- **Rain:** Summer is the driest season in Vancouver, though a light rain jacket is never a bad idea.
...
- Sunscreen — summer UV levels can be higher than expected at this latitude
...
- [Musqueam Indian Band official website](http://www.musqueam.bc.ca/) — The band's own site is the best place to learn about Musqueam history, governance, culture, and current initiatives directly from the community.
- [UBC Indigenous Portal: Musqueam & UBC](https://indigenous.ubc.ca/indigenous-engagement/musqueam-and-ubc/) — An overview of the UBC–Musqueam relationship, with links to key partnerships and initiatives.
- [Musqueam: Land Beneath Our Feet — UBC Library Resource Guide](https://guides.library.ubc.ca/Musqueam/home) — A curated guide from Xwi7xwa Library covering Musqueam history, culture, land, and related scholarship.
- [Connecting Communities: Principles for Musqueam-UBC Collaboration](https://sustain.ubc.ca/sites/sustain.ubc.ca/files/Sustainability%20Scholars/2015%20SS%20Projects/2015%20Executive%20Summaries/UBC-Musqueam%20Collaboration%20-%20UBC%20Sustainability%20Scholars%202015.pdf) — A report on the principles and procedures for respectful collaboration between UBC and the Musqueam Indian Band.
- [UBC Aboriginal Centennial](https://centennial.aboriginal.ubc.ca/) — Documents the history of UBC's relationship with Aboriginal peoples and communities, including the "hidden history" of how the university's early development obscured the long presence of Musqueam on the land.
